        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Public Browse link visible to all -->
                    ...
                    @if(Auth::check() && Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.settings.tax')" :active="request()->routeIs('admin.settings.*')">
                            {{ __('Settings') }}
                        </x-nav-link>

                        <!-- Comments admin link removed (feature disabled) -->
                    @endif
